...
//set your custom setttings from here ******************************************************
//******************************************************************************************
// Compilation-time options															********
#define LANG_CUR LANG_ENGLISH //languate == english									********
#define NWD_COUNTRY NWD_USA //non working day = USA									********
#define WEEK_STARTS_ON_SUNDAY true //Week starting day?								********
#define SHOW_WEEK_NUMBERS true //Week numbers?										********
//******************************************************************************************
//your custom setttings ends here **********************************************************
